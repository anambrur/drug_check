...
<head>
    <meta charset="utf-8">
    <title>New DOT Test Application</title>
    <style>
...
<div class="container">
    <div class="header">
        <h1>New DOT Test Application Paid</h1>
    </div>
    <div class="content">
        <p>A new paid DOT test application has been registered. Please review the details in the admin dashboard.</p>
