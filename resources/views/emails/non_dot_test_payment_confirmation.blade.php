...
<head>
    <meta charset="utf-8">
    <title>Non-DOT Payment Confirmation</title>
    <style>
...
<div class="container">
    <div class="header">
        <h1>Non-DOT Payment Confirmation</h1>
    </div>
    <div class="content">
        <p class="greeting">Dear {{ $application->first_name }} {{ $application->last_name }},</p>
        <div class="status-box">Your Non-DOT test payment was received successfully.</div>
        <p>Thank you for your payment. Your {{ $portfolio->title ?? 'Non-DOT' }} test has been scheduled.</p>
        <table class="details-table">
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $application->preferred_location ?? 'To be confirmed' }}</td>
                </tr>
                <tr>
                    <th>Reference</th>
