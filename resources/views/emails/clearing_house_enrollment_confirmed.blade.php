...
<head>
    <meta charset="utf-8">
    <title>Clearing House Enrollment Confirmed</title>
    <style>
        body {
...
<div class="container">
    <div class="header">
        <h1>Clearing House Enrollment Confirmed</h1>
    </div>
    
    <div class="content">
        <p class="greeting">Hello {{ $enrollment->first_name }} {{ $enrollment->last_name }},</p>
        
        <p>This email confirms that your company <strong>{{ $enrollment->company_name }}</strong> has been successfully enrolled in the Clearing House.</p>
