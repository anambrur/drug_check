            ...
            <div class="card">
                <div class="card-body">
                    ...
                    @if (count($categories) > 0)
                        ...
                        @else
                            <form onsubmit="return btnCheckListGet()" action="{{ route('background-category.destroy_checked') }}" method="POST">
                                @method('DELETE')
                                @csrf
                                @endif
                        ...
                        <table id="basic-datatable" class="table table-striped dt-responsive nowrap w-100">
                            ...
                            @foreach ($categories as $category)
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            <a href="{{ route('background-category.edit', $category->id) }}" class="mr-2">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                @if ($demo_mode == "on")
                                                    <!-- Include Alert Blade -->
                                                        @include('admin.demo_mode.demo-mode')
                                                    @else
                                                        <form class="d-inline-block" action="{{ route('background-category.destroy', $category->id) }}" method="POST">
                                                            @method('DELETE')
                                                            @csrf
                                                            @endif
            ...
            <div class="modal-content">
                ...
                @if ($demo_mode == "on")
                    <!-- Include Alert Blade -->
                        @include('admin.demo_mode.demo-mode')
                    @else
                        <form action="{{ route('background-category.store') }}" method="POST">
                            @csrf
                            @endif
