    ...
    <div class="row">
        <div class="col-xl-12 box-margin height-card">
            <div class="card card-body">
                <h4 class="card-title">Dot Supervisor Training
                    <div class="btn-group">
                ...
                @if (isset($item_section))
                    ...
                    @else
                        <form action="{{ route('dot-supervisor-training.update', $item_section->id) }}" method="POST"
                ...
                @else
                    @if ($demo_mode == 'on')
                        ...
                        @include('admin.demo_mode.demo-mode')
                    @else
                        <form action="{{ route('dot-supervisor-training.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                    @endif
