                    ...
                    @if (count($socials) > 0)
                        <table id="basic-datatable" class="table table-striped dt-responsive nowrap w-100">
                            ...
                            @foreach ($socials as $social)
                                <tr>
                                    <td>{{ $i++ }}</td>
                                    <td>@if ($social->social_media == 'fas fa-tiktok') <img src="{{ asset('uploads/img/dummy/tik-tok-white.svg') }}" alt="tiktok"> @else <i class="{{ $social->social_media }}"></i> @endif</td>
                                    <td>{{ $social->url }}</td>
                                    <td>
                                        @if ($demo_mode == "on")
                                            <!-- Include Alert Blade -->
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="social_media" id="social_media" required>
                                        ...
                                        <option value="fas fa-tiktok">TikTok</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-12">
