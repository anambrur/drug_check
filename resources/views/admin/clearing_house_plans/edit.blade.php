        ...
        <div class="col-xl-12 box-margin height-card">
            <div class="card card-body">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h4 class="card-title mb-0">Edit Clearing House Pricing Plan</h4>
                ...
                @else
                    <form id="plan-form" action="{{ route('admin.clearing-house-plans.update', $plan->id) }}" method="POST">
                        @method('PUT')
                        @csrf
                @endif
                ...
                <div class="row mt-3">
                    <div class="col-12">
                        <button type="submit" class="btn btn-primary mr-2">Update Clearing House Plan</button>
