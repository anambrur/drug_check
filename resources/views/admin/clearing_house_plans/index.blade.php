            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-20">
                        <h6 class="card-title mb-0">Clearing House Pricing Plans</h6>
                        <div>
                            <a href="{{ route('admin.clearing-house-plans.create') }}" class="btn btn-sm btn-primary">
                                <i class="fa fa-plus"></i> Add New Plan
                            </a>
                            <a href="{{ route('admin.clearing-house-plans.trashed') }}" class="btn btn-sm btn-warning">
                            ...
                            <tbody>
                                @foreach ($plans as $plan)
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{ route('admin.clearing-house-plans.toggle-status', $plan->id) }}" method="POST" style="display:inline;">
                                                @csrf
                                                @method('PATCH')
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('admin.clearing-house-plans.edit', ['id' => $plan->id]) }}"
                                                class="btn btn-sm btn-info mr-1">
                                                <i class="fa fa-edit"></i> Edit
                                            </a>
                                            <form action="{{ route('admin.clearing-house-plans.destroy', ['id' => $plan->id]) }}" method="POST" style="display:inline;" onsubmit="return confirm('Are you sure you want to delete/archive this plan?');">
                                                @csrf
                                                @method('DELETE')
                    ...
                    @else
                        <div class="text-center py-5">
                            ...
                            <h5>No clearing house pricing plans found</h5>
