            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-20">
                        <h6 class="card-title mb-0">Archived Clearing House Pricing Plans</h6>
                                ...
                                @foreach ($plans as $plan)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <form action="{{ route('admin.clearing-house-plans.restore', $plan->id) }}" method="POST" style="display:inline;">
                                                @csrf
                                                @method('PATCH')
