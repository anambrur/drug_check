...
@section('content')
        ...
        <div class="col-xl-12 box-margin height-card">
            <div class="card card-body">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h4 class="card-title mb-0">Create Clearing House Pricing Plan</h4>
                    <a href="{{ route('admin.clearing-house-plans.index') }}" class="btn btn-sm btn-secondary">
                ...
                @else
                    <form id="plan-form" action="{{ route('admin.clearing-house-plans.store') }}" method="POST">
                        @csrf
                @endif
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input type="number" name="display_order" id="display_order" class="form-control" min="0" value="0" required>
                        </div>
                    </div>
                ...
                <div class="mb-3">
                    ...
                    <p class="text-muted small">Configure the fees associated with this plan. You can choose whether they are flat fees or charged per driver.</p>
                </div>
                ...
                <div class="row mt-3">
                    <div class="col-12">
                        <button type="submit" class="btn btn-primary mr-2">Create Clearing House Plan</button>
                        <a href="{{ route('admin.clearing-house-plans.index') }}" class="btn btn-secondary">Cancel</a>
                    </div>
                </div>
                </form>
            </div>
    ...
    <script>
        // ─── Initial fee data ───────────────────────────────────────────────────
        var fees = [
            { fee_label: 'Annual C/TPA Enrollment Fee',  fee_key: 'annual_enrollment_fee',       fee_amount: 75.00,  fee_type: 'flat',       display_order: 1 },
            { fee_label: 'Clearinghouse Maintenance Fee', fee_key: 'clearinghouse_maintenance_fee', fee_amount: 25.00, fee_type: 'flat',      display_order: 2 },
            { fee_label: 'Query Administration Fee',     fee_key: 'query_admin_fee',             fee_amount: 12.50,  fee_type: 'flat',       display_order: 3 },
            { fee_label: 'Per-Driver Registration Fee',  fee_key: 'per_driver_fee',               fee_amount: 10.00,  fee_type: 'per_driver', display_order: 4 }
        ];
