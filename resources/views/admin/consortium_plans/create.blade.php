...
@section('content')
        ...
        <div class="col-xl-12 box-margin height-card">
            <div class="card card-body">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h4 class="card-title mb-0">Create Consortium Pricing Plan</h4>
                ...
                @else
                    <form id="plan-form" action="{{ route('admin.consortium-plans.store') }}" method="POST">
                        @csrf
                @endif
                ...
                <div class="row mt-3">
                    <div class="col-12">
                        <button type="submit" class="btn btn-primary mr-2">Create Consortium Plan</button>
    ...
    <script>
        // ─── Initial fee data ───────────────────────────────────────────────────
        var fees = [
            { fee_label: 'Annual Enrollment Fee',       fee_key: 'annual_enrollment_fee',       fee_amount: 75.00,  fee_type: 'flat',       display_order: 1 },
            ...
            { fee_label: 'FMCSA Queries Fee',            fee_key: 'fmcsa_queries_fee',            fee_amount: 12.50,  fee_type: 'flat',       display_order: 3 },
