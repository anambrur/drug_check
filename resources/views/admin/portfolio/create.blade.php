    ...
    <div class="row">
        <div class="col-xl-12 box-margin height-card">
            <div class="card card-body">
                <h4 class="card-title">{{ __('content.add_test_name') }}
                    <!-- Button -->
                    ...
                    <div id="imageModal" class="border border-success iyzi-modal">
                        <img class="img-fluid " src="{{ asset('uploads/img/dummy/style/portfolio-' . $style . '.jpg') }}"
                            alt="draft image">
                    </div>
                </h4>
                @if ($demo_mode == 'on')
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="section_image">{{ __('content.thumbnail') }} ({{ __('content.size') }} 600 x 600)
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <small
                                class="form-text text-muted">{{ __('content.when_you_leave_this_section_blank_it_will_go_to_its_own_detail_page') }}</small>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="lab_account" class="form-control" id="lab_account"
                                value="{{ old('lab_account') }}" placeholder="Enter Lab Account">
                        </div>
                    </div>
