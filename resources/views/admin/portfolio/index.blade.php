            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-md-flex justify-content-between align-items-center mb-20">
                        <h4 class="card-title mb-0">{{ __('content.test_name') }}
                            <div class="btn-group">
                        ...
                        <div>
                            ...
                            <a href="{{ url('admin/portfolio/create/'.$style) }}" class="btn btn-primary float-right mb-3">+ {{ __('content.add_test_name') }}</a>
                        </div>
                    </div>
