...
@section('content')
        ...
        <div class="col-xl-12 box-margin height-card">
            <div class="card card-body">
                ...
                @if (isset($item_section))
                    ...
                    @else
                        <form action="{{ route('about.update', $item_section->id) }}" method="POST"
                                            ...
                                            <div class="media">
                                                @if (!empty($item_section->section_image))
                                                    <a class="d-block mx-auto" href="#" data-toggle="tooltip"
                                                        ...
                                                        <img src="{{ asset('uploads/img/about/' . $item_section->section_image) }}"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="video_type" id="video_type">
                                    ...
                                    <option value="youtube" {{ $item_section->video_type == 'youtube' ? 'selected' : '' }}>
                                        {{ __('content.youtube') }}</option>
                                    <option value="other" {{ $item_section->video_type == 'other' ? 'selected' : '' }}>
                                        {{ __('content.other') }}</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="button_name" class="form-control" id="button_name"
                                    value="{{ $item_section->button_name }}">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="button_name_2" class="form-control" id="button_name_2"
                                    value="{{ $item_section->button_name_2 }}">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="avatar-area text-center">
                                            <div class="media">
                                                @if (!empty($item_section->cv_file))
                                                    <a class="d-block mx-auto"
                                                        href="{{ asset('uploads/img/about/' . $item_section->cv_file) }}"
                                            ...
                                            @if (!empty($item_section->cv_file))
                                                <a class="mt-3 d-block" href="#" data-toggle="modal"
                                                    data-target="#deleteModal2{{ $item_section->id }}">
                                                    <i class="fa fa-trash text-danger font-18"></i>
                                                </a>
                                            @endif
                                        </div>
                    ...
                    <!-- Modal -->
                    <div class="modal fade" id="deleteModal{{ $item_section->id }}" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-footer">
                                    ...
                                    @else
                                        <form class="d-inline-block"
                                            action="{{ route('about.destroy_image', $item_section->id) }}"
                                            method="POST">
                                            @method('DELETE')
                                            @csrf
                                    @endif
                    ...
                    <!-- Modal -->
                    <div class="modal fade" id="deleteModal2{{ $item_section->id }}" tabindex="-1" role="dialog"
                        aria-labelledby="messageModal2CenterTitle" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <div class="modal-footer">
                                    ...
                                    @else
                                        <form class="d-inline-block"
                                            action="{{ route('about.destroy_image_2', $item_section->id) }}"
                                            method="POST">
                                            @method('DELETE')
                                            @csrf
                                    @endif
                    ...
                    <!-- Modal -->
                    <div class="modal fade" id="aboutSectionDestroyModal{{ $item_section->id }}" tabindex="-1"
                        role="dialog" aria-labelledby="aboutSectionDestroyModalCenterTitle" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="bannerSectionDestroyModalCenterTitle">
                                ...
                                <div class="modal-footer">
                                    ...
                                    @else
                                        <form class="d-inline-block"
                                            action="{{ route('about.destroy', $item_section->id) }}" method="POST">
                                            @method('DELETE')
                                            @csrf
                                    @endif
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <small class="form-text text-muted">{{ __('content.recommended_tags') }} <span
                                        class="text-danger font-weight-bold custom-tag mr-1"
                                        onclick="insertTag('a', 'description')">{{ __('<a href="">') }}</span> <span
                                        class="text-danger font-weight-bold custom-tag mr-1"
                                        onclick="insertTag('br', 'description')">{{ __('<br>') }}</span> <span
                                        class="text-danger font-weight-bold custom-tag mr-1"
                                        onclick="insertTag('b', 'description')">{{ __('<b>') }}</span> <span
                                        class="text-danger font-weight-bold custom-tag mr-1"
                                        onclick="insertTag('i', 'description')">{{ __('<i>') }}</span> <span
                                        class="text-danger font-weight-bold custom-tag mr-1"
                                        onclick="insertTag('span', 'description')">{{ __('<span>') }}</span> <span
                                        class="text-danger font-weight-bold custom-tag mr-1"
                                        onclick="insertTag('p', 'description')">{{ __('<p>') }}</small>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                    ...
                    <div class="table-responsive order-stats">
                        @if (count($features) > 0)
                            ...
                            @if ($demo_mode == 'on')
                                ...
                                @include('admin.demo_mode.demo-mode')
                            @else
                                <form onsubmit="return btnCheckListGet()"
                            ...
                            <table id="basic-datatable" class="table table-striped dt-responsive w-100">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($features as $feature)
                                        <tr>
                                            <td>
                                                <input name="check_list[]" type="checkbox" value="{{ $feature->id }}"
                                                    onclick="showHideDeleteButton2(this)"> <span
                                                    class="d-none">{{ $asc++ }}{{ $desc-- }}</span>
                                            </td>
                                            ...
                                            <td>
                                                <div>
                                                    <a href="{{ route('about.edit_feature', $feature->id) }}"
                                                        class="mr-2">
                                                        <i class="fa fa-edit text-info font-18"></i>
                                                    </a>
                                                    <form class="d-inline-block"
                                                        action="{{ route('about.destroy_feature', $feature->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('DELETE')
                                                        <span data-toggle="modal"
                                                            data-target="#deleteModel{{ $feature->id }}">
                                                            <a type="button">
                                                                <i class="fa fa-trash text-danger font-18"></i>
                                                            </a>
                                                        </span>
                                                        <!-- Modal -->
                                                        <div class="modal fade" id="deleteModel{{ $feature->id }}"
    ...
    <div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title mt-0 font-16" id="myLargeModalLabel">{{ __('content.add_new') }}</h5><button
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <small class="form-text text-muted">{{ __('content.recommended_tags') }} <span
                                        class="text-danger font-weight-bold custom-tag mr-1"
                                        onclick="insertTag('a', 'title_2')">{{ __('<a href="">') }}</span> <span
                                        class="text-danger font-weight-bold custom-tag mr-1"
                                        onclick="insertTag('br', 'title_2')">{{ __('<br>') }}</span> <span
                                        class="text-danger font-weight-bold custom-tag mr-1"
                                        onclick="insertTag('b', 'title_2')">{{ __('<b>') }}</span> <span
                                        class="text-danger font-weight-bold custom-tag mr-1"
                                        onclick="insertTag('i', 'title_2')">{{ __('<i>') }}</span> <span
                                        class="text-danger font-weight-bold custom-tag mr-1"
                                        onclick="insertTag('span', 'title_2')">{{ __('<span>') }}</span> <span
                                        class="text-danger font-weight-bold custom-tag mr-1"
                                        onclick="insertTag('p', 'title_2')">{{ __('<p>') }}</small>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <small class="form-text text-muted">{{ __('content.recommended_tags') }} <span
                                        class="text-danger font-weight-bold custom-tag mr-1"
                                        onclick="insertTag('a', 'description_2')">{{ __('<a href="">') }}</span> <span
                                        class="text-danger font-weight-bold custom-tag mr-1"
                                        onclick="insertTag('br', 'description_2')">{{ __('<br>') }}</span> <span
                                        class="text-danger font-weight-bold custom-tag mr-1"
                                        onclick="insertTag('b', 'description_2')">{{ __('<b>') }}</span> <span
                                        class="text-danger font-weight-bold custom-tag mr-1"
                                        onclick="insertTag('i', 'description_2')">{{ __('<i>') }}</span> <span
                                        class="text-danger font-weight-bold custom-tag mr-1"
                                        onclick="insertTag('span', 'description_2')">{{ __('<span>') }}</span> <span
                                        class="text-danger font-weight-bold custom-tag mr-1"
                                        onclick="insertTag('p', 'description_2')">{{ __('<p>') }}</small>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
