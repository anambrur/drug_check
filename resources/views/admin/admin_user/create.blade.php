                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group form-group-default">
                                    <label for="role_id">{{ __('content.role_name') }} <span
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="password">{{ __('content.new_password') }} <span
                                            class="text-red">*</span></label>
                            ...
                            <div class="col-md-12">
                                <div class="form-group form-group-default">
                                    <label for="status">{{ __('content.role_name') }} <span
                                            class="text-red">*</span></label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group ">
                                    <label for="image">{{ __('content.image') }} ({{ __('content.size') }}
                                        128x128)(.png, .jpg, .jpeg)</label>
                                    <input id="image" name="profile_photo_path" type="file"
