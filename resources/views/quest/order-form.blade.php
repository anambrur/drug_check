                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text"
                                                ...
                                                placeholder="Last name" required maxlength="25">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text"
                                                ...
                                                placeholder="Middle name" maxlength="20">
                                    ...
                                    @if (str_contains(strtolower($paymentData['portfolio']->title), 'physical'))
                                        <div class="col-md-6">
                                            <div class="form-floating">
                                                ...
                                                <label for="primary_id_type">Primary ID Type (Physical only)</label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="tel"
                                                ...
                                                value="{{ old('secondary_phone') }}" placeholder="Secondary phone">
                                ...
                                <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-floating">
                                                <input type="text"
                                                    ...
                                                    placeholder="Collection Site ID" maxlength="6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            ...
                                            <small class="text-muted">For ePhysical, must be within 7 days</small>
                                            @error('end_datetime')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            ...
                                            <label for="end_datetime_timezone_id">Timezone (if expiration set)</label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text"
                                                ...
                                                placeholder="Contact Name" maxlength="45">
                                    ...
                                    <div class="col-12">
                                        <div class="form-floating">
                                            <textarea class="form-control @error('order_comments') is-invalid @enderror" name="order_comments"
                                                id="order_comments" placeholder="Special instructions" style="height: 100px" maxlength="250">{{ old('order_comments') }}</textarea>
                                    ...
                                    <div class="col-12">
                                        <div class="form-floating">
                                            <input type="url"
                                                ...
                                                name="response_url" id="response_url" value="{{ old('response_url') }}"
                                                placeholder="Response URL" maxlength="255">
                                            <label for="response_url">Response URL (optional)</label>
                                            @error('response_url')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
