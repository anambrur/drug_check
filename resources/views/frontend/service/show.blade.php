...
<head>
    ...
    <meta name="title"
        content="@if (!empty($service->title)) {{ $service->title }} @elseif (!empty($page_builder->meta_title)) {{ $page_builder->meta_title }} @elseif (isset($seo)){{ $seo->meta_title }} @endif">
    <meta name="description"
        content="@if (!empty($service_content->meta_description)) {{ $service_content->meta_description }} @elseif (!empty($page_builder->meta_description)) {{ $page_builder->meta_description }} @elseif (isset($seo)){{ $seo->meta_description }} @endif">
    <meta name="keywords"
        content="@if (!empty($service_content->meta_keyword)) {{ $service_content->meta_keyword }} @elseif (!empty($page_builder->meta_keyword)) {{ $page_builder->meta_keyword }} @elseif (isset($seo)){{ $seo->meta_keyword }} @endif">
    ...
    <!-- Title -->
    <title>
        @if (!empty($service->title)) {{ $service->title }}
