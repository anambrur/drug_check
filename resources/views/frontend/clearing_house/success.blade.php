...
@php
    ...
    $chRegisteredLabel = match ($enrollment->clearinghouse_registered ?? null) {
        'yes' => 'Yes',
        'no' => 'No',
        'unsure' => 'Unsure',
        default => null,
...
<div class="pf-show-page rc-success-page ch-page" id="ch-success-page">
        ...
        <div class="container position-relative">
            <div class="rc-hero-content text-center">
                ...
                <div class="rc-hero-desc rc-hero-item rc-hero-item--3">
                    Thank you. Your paid C/TPA Clearing House enrollment has been registered successfully.
    ...
    {{-- Next steps + receipt --}}
    <section class="pf-show-intro rc-success-body" aria-labelledby="ch-success-heading">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8 col-xl-7 pf-show-action-col">
                    ...
                    <div class="rc-section-head text-center rc-animate mb-4 mb-lg-5">
                        ...
                        <h2 id="ch-success-heading">What Happens Next?</h2>
                        <p class="sub">Complete these FMCSA Clearinghouse steps so Skyros can finish your C/TPA onboarding.</p>
                    </div>
                        ...
                        <div class="pf-body pt-3">
                            <ol class="rc-success-steps mb-0">
                                <li>
                                    ...
                                    <div>
                                        <strong>Register / Log In at FMCSA Clearinghouse</strong>
                                        <p class="mb-0">
                                            Create or sign in to your employer account at
                                ...
                                <li>
                                    ...
                                    <div>
                                        <strong>Purchase Official Query Plan</strong>
                                        <p class="mb-0">
                                            Buy your official FMCSA query plan ($1.25 per query) on the FMCSA Clearinghouse site.
                                            These are separate from Skyros C/TPA service fees.
                                        </p>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div>
                                        <strong>Designate Skyros &amp; Authorize Roles</strong>
                                        <p class="mb-0">
                                            Designate <strong>Drugcheckr</strong> as your C/TPA and authorize
                                            Conduct Queries, Report Violations, and Report RTD as applicable.
                                        </p>
                                    </div>
                                </li>
                                <li>
                                    <span class="rc-success-step-num" aria-hidden="true">4</span>
                                    <div>
                                        <strong>Skyros Completes Onboarding</strong>
                                        <p class="mb-0">
                                            Once designated, Skyros accepts the request and finishes your C/TPA Clearing House onboarding.
                                        </p>
                                    </div>
                                </li>
                            </ol>
                    ...
                    <div class="summary-card pf-show-pricing-card rc-animate">
                        ...
                        <ul class="pf-pricing-details">
                            ...
                            @if (!is_null($enrollment->is_owner_operator))
                                <li>
                                    <span class="fee-label"><i class="fas fa-user-check" aria-hidden="true"></i> Owner-Operator</span>
                                    <span class="fee-val">{{ $enrollment->is_owner_operator ? 'Yes' : 'No' }}</span>
                                </li>
                            @endif

                            @if ($chRegisteredLabel)
                                <li>
                                    <span class="fee-label"><i class="fas fa-database" aria-hidden="true"></i> Clearinghouse Registered</span>
                                    <span class="fee-val">{{ $chRegisteredLabel }}</span>
                                </li>
                            @endif

                            @if ($enrollment->authorize_conduct_queries || $enrollment->authorize_report_violations || $enrollment->authorize_report_rtd)
                                <li>
                                    <span class="fee-label"><i class="fas fa-file-signature" aria-hidden="true"></i> Authorizations</span>
                                    <span class="fee-val">
                                        @php
                                            $auths = [];
                                            if ($enrollment->authorize_conduct_queries) $auths[] = 'Conduct Queries';
                                            if ($enrollment->authorize_report_violations) $auths[] = 'Report Violations';
                                            if ($enrollment->authorize_report_rtd) $auths[] = 'Report RTD';
                                        @endphp
                                        {{ implode(', ', $auths) }}
                                    </span>
                                </li>
                        ...
                        <div class="d-flex flex-wrap gap-2 justify-content-center mt-3">
                            <a href="{{ route('frontend.clearing-house') }}" class="pf-btn-submit pf-show-scroll-cta text-decoration-none">
                                <i class="fas fa-database" aria-hidden="true"></i>
                                Back to Clearing House
                            </a>
                    ...
                    <ul class="pf-show-benefits rc-animate" aria-label="Enrollment reminders">
                        ...
                        <li><i class="fas fa-university" aria-hidden="true"></i> Complete FMCSA designation next</li>
                    </ul>
                </div>
            </div>
        </div>
