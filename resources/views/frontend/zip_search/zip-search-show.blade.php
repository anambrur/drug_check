    ...
    <div class="page-wrapper" id="wrapper">
        ...
        <main class="main-area">
            <div class="container" style="margin-top: 100px">
                <h4 class="text-center p-4">Search Results for ZIP: {{ $zip }} ({{ $radius }} miles)</h4>
            
                @if (empty($places))
                    <p>No locations found in the selected radius.</p>
                @else
                <ul>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <p class="card-text">
                                                {{ $place['address'] }}<br>
                                                <strong>Distance:</strong> {{ $place['distance'] }}<br>
                                                <strong>Categories:</strong> {{ $place['categories'] }}
                                            </p>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="d-flex align-items-center justify-content-end gap-2">
                                                <button class="btn btn-primary">
                                                    <span><i class="fa fa-phone-square"></i>  (800)-221-4291</span>
                                                </button>
                                            ...
                                            <div class="d-flex justify-content-end mt-2">
                                                <a href="https://www.google.com/maps/place/?q=place_id:{{ $place['place_id'] }}" target="_blank" class="">
                                                    Get Directions
                                                </a>
                                            </div>
                                        </div>
                    ...
                    <script>
                        function initMap() {
                            const map = new google.maps.Map(document.getElementById('map'), {
                                zoom: 12,
                                center: { 
                                    lat: {{ $places[0]['latitude'] ?? 0 }}, 
                                    lng: {{ $places[0]['longitude'] ?? 0 }} 
                                }
                            });
                        ...
                        // Ensure Google Maps API is fully loaded before initializing the map
