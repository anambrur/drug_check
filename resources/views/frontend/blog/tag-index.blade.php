...
@section('content')
    ...
    @php
        ...
        $tagLabel = ($tag_name ?? null) && $tag_name !== 'draft_page'
            ? $tag_name
            : (__('frontend.tags') ?? 'Tags');
    @endphp
        ...
        <section class="rc-hero rc-hero--blog">
            ...
            <div class="container position-relative">
                <div class="rc-hero-content text-center">
                    ...
                    <h1 class="rc-hero-title rc-hero-item rc-hero-item--2" id="bl-tag-heading">{{ $tagLabel }}</h1>
                ...
                @else
                    <div class="pf-card svc-empty-card text-center rc-animate">
                        <div class="pf-body py-5">
                            ...
                            <p class="ch-text-muted mb-3">No articles found for this tag.</p>
                            @if (!empty($blog_index?->page_uri))
