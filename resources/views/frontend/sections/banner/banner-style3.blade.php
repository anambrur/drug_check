        ...
        <ul class="hero-social-list">
            @foreach ($socials as $social)
                @if ($social->social_media == 'fab fa-twitter')
                    <li><a href="{{ $social->url }}"><img src="{{ asset('uploads/img/dummy/x-twitter-white.svg') }}"
                                alt="x icon"></a></li>
                @elseif ($social->social_media == 'fas fa-tiktok')
                    <li><a href="{{ $social->url }}"><img src="{{ asset('uploads/img/dummy/tik-tok-white.svg') }}"
                                alt="x icon" class="custom-max-width-16"></a></li>
                @else
