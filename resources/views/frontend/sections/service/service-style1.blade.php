        ...
        @if (is_countable($services_style1) && count($services_style1) > 0)
            <div class="row">
                @foreach ($services_style1 as $item)
                    <div class="col-lg-3 col-md-6 wow fadeInLeft" data-wow-duration="0.5s"
                        ...
                        <div class="services-item">
                            {{-- @if (!empty($item->section_image_2))
                                <img src="{{ asset('uploads/img/service/' . $item->section_image_2) }}"
                                    alt="Services image" class="services-bg-img">
                            @endif --}}
                            <div class="body">
                                ...
                                @if (!empty($item->button_name))
                                    <div class="btn-box">
                                        <a
                                            href="{{ route('default-service-detail-show', ['service_slug' => $item->service_slug]) }}">{{ $item->button_name }}
                                            <i class="fa fa-arrow-right"></i></a>
                                    </div>
                                @else
                                    <div class="btn-box">
                                        <a
                                            href="{{ route('default-service-detail-show', ['service_slug' => $item->service_slug]) }}">{{ __('frontend.read_more') }}
                                            <i class="fa fa-arrow-right"></i></a>
                                    </div>
                                @endif
                            </div>
                            <div>
                                <img src="{{ asset('uploads/img/service/' . $item->section_image_2) }}"
                                    alt="Services image" class=" pt-2 img-fluid rounded-circle">
                            </div>
                            @if ($item->type == 'icon')
                                @if (!empty($item->icon))
                                    <div class="icon">
                            ...
                            @else
                                @if (!empty($item->section_image))
                                    <div class="icon">
                                        <img class="custom-max-width-80"
                                            src="{{ asset('uploads/img/service/' . $item->section_image) }}"
                                            alt="service icon">
                                    </div>
                                @endif
                            @endif
            ...
            @if (Auth::user() || $draft_view == null || $draft_view->status == 'enable')
                <div class="row">
                    <div class="col-lg-4 col-md-6 wow fadeInLeft" data-wow-duration="0.5s" data-wow-delay="0.1s">
                        <div class="services-item">
                            <img src="{{ asset('uploads/img/dummy/600x600.jpg') }}" alt="Services image"
