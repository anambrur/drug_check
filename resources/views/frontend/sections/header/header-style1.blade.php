<!--// Header Start //-->
<header class="header fixed-top bg-white" id="header" >
                            ...
                            @foreach ($menus as $menu)
                                @if ($menu->submenus->count() > 0)
                                    <li class="nav-item dropdown ">
                                        <a class="nav-link dropdown-toggle text-dark" id="{{ $menu->menu_name }}DropdownMenu" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            {{ $menu->menu_name }}
                                        </a>
                                        @if ($menu->submenus->count() > 0)
