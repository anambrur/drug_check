...
<section class="section" id="portfolio-single-page">
    ...
    {{-- <div class="sidebar-widgets">
        ...
        <div class="contact-form-wrap p-3 d-flex align-items-center">
            <form id="payment-form" action="{{ route('send.mail_dot') }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 p-4">
                        <div class="contact-form-group">
                            <label for="gender" class="font-weight-bold mb-2">Gender:</label>
                    ...
                    <div class="col-md-12 d-flex">
                        <div class="contact-form-group">
                            <select class="form-select select_input" name="reason_for_testing">
                    ...
                    <div class="col-md-6">
                        <label for="card-element" class="font-weight-bold">Enter Payment Details</label>
                    ...
                    <div class="col-md-12 text-center mt-3">
                        <div class="contact-btn-left">
                            <button type="button" id="pay-button" class="primary-btn p-2"
    ...
    <div class="sidebar-widgets d-flex justify-content-center">
        <div class="contact-form-wrap p-3 w-100" style="max-width: 600px;">
            <h5 class="inner-header-title text-center">Apply For Testing</h5>
            <form id="payment-form" action="{{ route('send.mail_dot') }}" method="POST">
                @csrf
                <input type="hidden" name="payment_intent_id" id="payment_intent_id">
