...
<div class="main-container-wrapper">
            ...
            @isset($panel_image)
                ...
                @if (!empty($panel_image->section_image))
                    <a class="navbar-brand brand-logo mr-5" href="{{ url('dashboard') }}">
                        <img src="{{ asset('uploads/img/general/' . $panel_image->section_image) }}" class="mr-2"
                            alt="logo" />
                    </a>
                @endif
        ...
        <div class="navbar-menu-wrapper d-flex align-items-center justify-content-between">
            ...
            <ul class="navbar-nav mr-lg-2">
                ...
                <li class="nav-item dropdown dropdown-animate">
                    <a href="#" class="count-indicator" data-toggle="modal"
                        data-target="#processedLanguageModal">
            ...
            <ul class="top-navbar-area navbar-nav navbar-nav-right">
                ...
                <li class="nav-item nav-profile dropdown dropdown-animate">
                    <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown">
                        ...
                        @else
                            <img src="{{ asset('uploads/img/dummy/128x128.jpg') }}"
                                class="img-profile rounded-circle" alt="profile image">
                        @endif
                    </a>
                    <div class="dropdown-menu dropdown-menu-right navbar-dropdown profile-top"
                        ...
                        <a href="{{ url('admin/profile/edit') }}" class="dropdown-item"><i
                                class="fas fa-user profile-icon" aria-hidden="true"></i>
                            {{ __('content.profile') }}</a>
                        <a href="{{ url('admin/profile/change-password') }}" class="dropdown-item"><i
                                class="fas fa-unlock-alt profile-icon" aria-hidden="true"></i>
                            {{ __('content.change_password') }}</a>
            ...
            <ul class="nav">
                ...
                @can('blog view')
                    <li
                        ...
                        request()->is('admin/blog-detail/*/*/edit')
                            ? 'active'
                            : '' }}">
                        ...
                        request()->is('admin/blog-detail/*/*/edit')
                            ...
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a
                                        class="nav-link {{ request()->is('admin/category/create') || request()->is('admin/category/*/edit') ? 'active' : '' }}"
                                        href="{{ url('admin/category/create') }}">{{ __('content.categories') }}</a></li>
                                <li class="nav-item"> <a
                                        class="nav-link {{ request()->is('admin/blog/create') ? 'active' : '' }}"
                                        href="{{ url('admin/blog/create') }}">{{ __('content.add_blog') }}</a></li>
                                <li class="nav-item"> <a
                                        class="nav-link {{ request()->is('admin/blog') ||
                                        request()->is('admin/blog/*/edit') ||
                                        request()->is('admin/blog-image/*/create') ||
                                        request()->is('admin/blog-image/*/*/edit') ||
                                        request()->is('admin/blog-detail/*/create') ||
                ...
                @can('section view')
                    <li
                        class="nav-item {{ request()->is('admin/banner/create/*') ||
                        ...
                        <div class="collapse {{ request()->is('admin/banner/create/*') ||
                        request()->is('admin/banner/create') ||
                        request()->is('admin/about/create/*') ||
                        request()->is('admin/about/create') ||
                        request()->is('admin/about-feature/*/edit') ||
                        ...
                        request()->is('admin/subscribe-section/create')
                            ...
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a
                                        class="nav-link {{ request()->is('admin/banner/create/*') || request()->is('admin/banner/create') ? 'active' : '' }}"
                                        href="{{ url('admin/banner/create') }}">{{ __('content.banner') }}</a></li>
                                <li class="nav-item"> <a
                                        class="nav-link {{ request()->is('admin/about/create/*') || request()->is('admin/about/create') || request()->is('admin/about-feature/*/edit') ? 'active' : '' }}"
                                        href="{{ url('admin/about/create') }}">{{ __('content.about') }}</a></li>
                                <li class="nav-item"> <a
                                        class="nav-link {{ request()->is('admin/history/create/*') || request()->is('admin/history/create') || request()->is('admin/history/*/edit') ? 'active' : '' }}"
                                        href="{{ url('admin/history/create') }}">{{ __('content.history') }}</a></li>
                                <li class="nav-item"> <a
                                        class="nav-link {{ request()->is('admin/feature/create/*') || request()->is('admin/feature/create') || request()->is('admin/feature/*/edit') ? 'active' : '' }}"
                                        href="{{ url('admin/feature/create') }}">{{ __('content.features') }}</a></li>
                                <li class="nav-item"> <a
                                        class="nav-link {{ request()->is('admin/counter/create/*') || request()->is('admin/counter/create') || request()->is('admin/counter/*/edit') ? 'active' : '' }}"
                                        href="{{ url('admin/counter/create') }}">{{ __('content.counters') }}</a></li>
                                <li class="nav-item"> <a
                                        class="nav-link {{ request()->is('admin/work-process/create/*') || request()->is('admin/work-process/create') || request()->is('admin/work-process/*/edit') ? 'active' : '' }}"
                                        href="{{ url('admin/work-process/create') }}">{{ __('content.work_process') }}</a>
                                </li>

                                <li class="nav-item"> <a
                                        class="nav-link {{ request()->is('admin/call-to-action/create/*') || request()->is('admin/call-to-action/create') ? 'active' : '' }}"
                                        href="{{ url('admin/call-to-action/create') }}">{{ __('content.call_to_action') }}</a>
                                </li>
                                <li class="nav-item"> <a
                                        class="nav-link {{ request()->is('admin/testimonial/create/*') || request()->is('admin/testimonial/create') || request()->is('admin/testimonial/*/edit') ? 'active' : '' }}"
                                        href="{{ url('admin/testimonial/create') }}">{{ __('content.testimonials') }}</a>
                                </li>
                                <li class="nav-item"> <a
                                        class="nav-link {{ request()->is('admin/sponsor/create/*') || request()->is('admin/sponsor/create') || request()->is('admin/sponsor/*/edit') ? 'active' : '' }}"
                                        href="{{ url('admin/sponsor/create') }}">{{ __('content.sponsors') }}</a></li>
                                <li class="nav-item"> <a
                                        class="nav-link {{ request()->is('admin/video/create/*') || request()->is('admin/video/create') ? 'active' : '' }}"
                                        href="{{ url('admin/video/create') }}">{{ __('content.video') }}</a></li>
                                <li class="nav-item"> <a
                                        class="nav-link {{ request()->is('admin/faq/create/*') || request()->is('admin/faq/create') || request()->is('admin/faq/*/edit') ? 'active' : '' }}"
                                        href="{{ url('admin/faq/create') }}">{{ __('content.faqs') }}</a></li>
                                <li class="nav-item"> <a
                                        class="nav-link {{ request()->is('admin/plan/create') || request()->is('admin/plan/*/edit') ? 'active' : '' }}"
                                        href="{{ url('admin/plan/create') }}">{{ __('content.plan') }}</a></li>
                                <li class="nav-item"> <a
                                        class="nav-link {{ request()->is('admin/subscribe-section/create/*') || request()->is('admin/subscribe-section/create') ? 'active' : '' }}"
                                        href="{{ url('admin/subscribe-section/create') }}">{{ __('content.subscribe') }}</a>
                                </li>
                                <li class="nav-item"> <a
                                        class="nav-link {{ request()->is('admin/contact-info/create/*') || request()->is('admin/contact-info/create') ? 'active' : '' }}"
                                        href="{{ url('admin/contact-info/create') }}">{{ __('content.contact_info') }}</a>
                                </li>
                                <li class="nav-item"> <a
                                        class="nav-link {{ request()->is('admin/map/create/*') || request()->is('admin/map/create') ? 'active' : '' }}"
                                        href="{{ url('admin/map/create') }}">{{ __('content.map') }}</a></li>
                                <li class="nav-item"> <a
                                        class="nav-link {{ request()->is('admin/footer/create') || request()->is('admin/footer/*/edit') || request()->is('admin/footer') || request()->is('admin/footer-category/create') || request()->is('admin/footer-category/*/edit') ? 'active' : '' }}"
                                        href="{{ url('admin/footer') }}">{{ __('content.footer') }}</a></li>
                            </ul>
                        </div>
                    </li>
                @endcan
                @can('service view')
                    <li
                        class="nav-item {{ request()->is('admin/service/style1') ||
                        ...
                        request()->is('admin/service-feature/*/*/edit')
                            ? 'active'
                            : '' }}">
                        ...
                        request()->is('admin/service-feature/*/*/edit')
                            ...
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a
                                        class="nav-link {{ request()->is('admin/service-category/create') || request()->is('admin/service-category/*/edit') ? 'active' : '' }}"
                                        href="{{ url('admin/service-category/create') }}">{{ __('content.categories') }}</a>
                                </li>
                                <li class="nav-item"> <a
                                        class="nav-link {{ request()->is('admin/service/style1') ||
                                        request()->is('admin/service-content/*/create') ||
                                        request()->is('admin/service-info/*/create') ||
                                        request()->is('admin/service/create/*') ||
                                        request()->is('admin/service-feature/*/create') ||
                                        request()->is('admin/service-feature/*/*/edit')
                                            ? 'active'
                                            : '' }}"
                                        href="{{ url('admin/service/style1') }}">{{ __('content.services') }}</a></li>
                            </ul>
                        </div>
                    </li>
                @endcan
                ...
                @can('background view')
                    <li
                        class="nav-item {{ request()->is('admin/background/style1') ||
                        request()->is('admin/background-content/*/create') ||
                        request()->is('admin/background-info/*/create') ||
                        request()->is('admin/background/create/*') ||
                        request()->is('admin/background/*/edit') ||
                        request()->is('admin/why-choose/create/*') ||
                        request()->is('admin/why-choose/create') ||
                        request()->is('admin/why-choose/*/edit') ||
                        request()->is('admin/package-category/create') ||
                        request()->is('admin/package-category/*/edit') ||
                        request()->is('admin/package-feature/*/create') ||
                        request()->is('admin/package-feature/*/*/edit') ||
                        request()->is('admin/background-category/create') ||
                        request()->is('admin/background-category/*/edit') ||
                        request()->is('admin/package') ||
                        request()->is('admin/package/create') ||
                        request()->is('admin/package/*/edit') ||
                        request()->is('admin/background-feature/*/create') ||
                        request()->is('admin/background-feature/*/*/edit')
                            ? 'active'
                            : '' }}">
                        ...
                        <div class="collapse {{ request()->is('admin/background/style1') ||
                        request()->is('admin/background-content/*/create') ||
                        request()->is('admin/background-info/*/create') ||
                        request()->is('admin/background/create/*') ||
                        request()->is('admin/background/*/edit') ||
                        ...
                        request()->is('admin/background-feature/*/*/edit')
                            ...
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> 
                                    <a
                                        class="nav-link {{ request()->is('admin/background-category/create') || request()->is('admin/background-category/*/edit') ? 'active' : '' }}"
                                        href="{{ url('admin/background-category/create') }}">{{ __('content.categories') }}
                                    </a>
                                </li>
                                
                                <li class="nav-item">
                                    <a class="nav-link {{ request()->is('admin/background/style1') ||
                                    request()->is('admin/background-content/*/create') ||
                                    request()->is('admin/background-info/*/create') ||
                                    request()->is('admin/background/create/*') ||
                                    request()->is('admin/background-feature/*/create') ||
                                    request()->is('admin/background-feature/*/*/edit')
                                        ? 'active'
                                        : '' }}"
                                        href="{{ url('admin/background/create/style1') }}">Background
                                    </a>
                                </li>

                                <li class="nav-item"> 
                                    <a
                                        class="nav-link {{ request()->is('admin/package-category/create') || request()->is('admin/package-category/*/edit') ? 'active' : '' }}"
                                        href="{{ url('admin/package-category/create') }}">Packages Category
                                    </a>
                                </li>
                                <li class="nav-item"> 
                                    <a
                                        class="nav-link {{ request()->is('admin/package/create') || request()->is('admin/package/*/edit') ? 'active' : '' }}"
                                        href="{{ url('admin/package/create') }}">Add Packages
                                    </a>
                                </li>
                                <li class="nav-item"> 
                                    <a
                                        class="nav-link {{ request()->is('admin/package') || request()->is('admin/package') ? 'active' : '' }}"
                                        href="{{ url('admin/package') }}">Packages
                                    </a>
                                </li>

                                <li class="nav-item"> <a
                                        class="nav-link {{ request()->is('admin/why-choose/create/*') || request()->is('admin/why-choose/create') || request()->is('admin/why-choose/*/edit') ? 'active' : '' }}"
                                        href="{{ url('admin/why-choose/create') }}">{{ __('content.why_choose') }}</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                ...
                @can('team view')
                    <li
                        ...
                        request()->is('admin/team-category/*/edit')
                            ? 'active'
                            : '' }}">
                        <a class="nav-link" data-toggle="collapse" href="#teams" aria-expanded="false"
                            aria-controls="teams">
                        ...
                        request()->is('admin/team-category/*/edit')
                            ...
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a
                                        class="nav-link {{ request()->is('admin/team-category/create') || request()->is('admin/team-category/*/edit') ? 'active' : '' }}"
                                        href="{{ url('admin/team-category/create') }}">{{ __('content.categories') }}</a>
                                </li>
                                <li class="nav-item"> <a
                                        class="nav-link {{ request()->is('admin/team/style1') || request()->is('admin/team/create/*') ? 'active' : '' }}"
                                        href="{{ url('admin/team/style1') }}">{{ __('content.teams') }}</a></li>
                            </ul>
                        </div>
                    </li>
                @endcan
                @can('gallery view')
                    <li
                        class="nav-item {{ request()->is('admin/gallery') ||
                        request()->is('admin/gallery/create') ||
                        request()->is('admin/gallery/*/edit')
                            ? 'active'
                            : '' }}">
                        ...
                        request()->is('admin/gallery/*/edit')
                            ...
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a
                                        ...
                                        href="{{ url('admin/gallery/create') }}">{{ __('content.add_gallery') }}</a>
                                </li>
                                <li class="nav-item"> <a
                                        class="nav-link {{ request()->is('admin/gallery') ? 'active' : '' }}"
                                        href="{{ url('admin/gallery') }}">{{ __('content.gallery') }}</a></li>
                            </ul>
                        </div>
                    </li>
                @endcan
                @can('career view')
                    <li
                        class="nav-item {{ request()->is('admin/career/style1') ||
                        ...
                        request()->is('admin/career-category/*/edit')
                            ? 'active'
                            : '' }}">
                        <a class="nav-link" data-toggle="collapse" href="#careers" aria-expanded="false"
                        ...
                        request()->is('admin/career-category/*/edit')
                            ...
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a
                                        class="nav-link {{ request()->is('admin/career-category/create') || request()->is('admin/career-category/*/edit') ? 'active' : '' }}"
                                        href="{{ url('admin/career-category/create') }}">{{ __('content.categories') }}</a>
                                </li>
                                <li class="nav-item"> <a
                                        class="nav-link {{ request()->is('admin/career/style1') ||
                                        request()->is('admin/career-content/*/create') ||
                                        request()->is('admin/career/create/*')
                                            ? 'active'
                                            : '' }}"
                                        href="{{ url('admin/career/style1') }}">{{ __('content.careers') }}</a></li>
                            </ul>
                        </div>
                    </li>
                @endcan
                @can('page view')
                    <li
                        class="nav-item {{ request()->is('admin/page') || request()->is('admin/page/create') || request()->is('admin/page/*/edit')
                            ? 'active'
                            : '' }}">
                        ...
                        <div class="collapse {{ request()->is('admin/page') || request()->is('admin/page/create') || request()->is('admin/page/*/edit')
                            ? 'show'
                            : '' }}"
                            id="pages">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a
                                        ...
                                        href="{{ url('admin/page/create') }}">{{ __('content.add_page') }}</a></li>
                                <li class="nav-item"> <a
                                        class="nav-link {{ request()->is('admin/page') || request()->is('admin/page/*/edit') ? 'active' : '' }}"
                                        href="{{ url('admin/page') }}">{{ __('content.pages') }}</a></li>
                            </ul>
                        </div>
                    </li>
                @endcan
                @can('contact message view')
                    <li
                        ...
                        <a class="nav-link" data-toggle="collapse" href="#contact-message" aria-expanded="false"
                            aria-controls="contact-message">
                            <i class="fas fa-map-marked menu-icon"></i>
                            <span class="menu-title">{{ __('content.contact') }}</span>
                            <i class="ti-angle-right"></i>
                        </a>
                        <div class="collapse {{ request()->is('admin/contact-message') ? 'show' : '' }}"
                            id="contact-message">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a
                                        class="nav-link {{ request()->is('admin/contact-message') ? 'active' : '' }}"
                                        href="{{ url('admin/contact-message') }}">{{ __('content.messages') }}</a></li>
                            </ul>
                        </div>
                    </li>
                @endcan
                ...
                @can('setting view')
                    <li
                        ...
                        request()->is('admin/quick-access/create')
                            ...
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a
                                        class="nav-link {{ request()->is('admin/preloader/create') ? 'active' : '' }}"
                                        href="{{ url('admin/preloader/create') }}">{{ __('content.preloader') }}</a>
                                </li>
                                <li class="nav-item"> <a
                                        class="nav-link {{ request()->is('admin/favicon/create') ? 'active' : '' }}"
                                        href="{{ url('admin/favicon/create') }}">{{ __('content.favicon') }}</a></li>
                                <li class="nav-item"> <a
                                        class="nav-link {{ request()->is('admin/header-info/create') || request()->is('admin/header-info/create/*') ? 'active' : '' }}"
                                        href="{{ url('admin/header-info/create') }}">{{ __('content.header_info') }}</a>
                                </li>
                                <li class="nav-item"> <a
                                        class="nav-link {{ request()->is('admin/header-image/create/*') || request()->is('admin/header-image/create') ? 'active' : '' }}"
                                        href="{{ url('admin/header-image/create') }}">{{ __('content.header_image') }}</a>
                                </li>
                                <li class="nav-item"> <a
                                        class="nav-link {{ request()->is('admin/footer-image/create/*') || request()->is('admin/footer-image/create') ? 'active' : '' }}"
                                        href="{{ url('admin/footer-image/create') }}">{{ __('content.footer_image') }}</a>
                                </li>
                                <li class="nav-item"> <a
                                        class="nav-link {{ request()->is('admin/panel-image/create') || request()->is('admin/panel-image/create') ? 'active' : '' }}"
                                        href="{{ url('admin/panel-image/create') }}">{{ __('content.panel_image') }}</a>
                                </li>
                                <li class="nav-item"> <a
                                        class="nav-link {{ request()->is('admin/external-url/create') ? 'active' : '' }}"
                                        href="{{ url('admin/external-url/create') }}">{{ __('content.external_url') }}</a>
                                </li>
                                <li class="nav-item"> <a
                                        class="nav-link {{ request()->is('admin/contact-info-widget/create') || request()->is('admin/contact-info-widget/create/*') ? 'active' : '' }}"
                                        href="{{ url('admin/contact-info-widget/create') }}">{{ __('content.contact_info_widget') }}</a>
                                </li>
                                <li class="nav-item"> <a
                                        class="nav-link {{ request()->is('admin/breadcrumb-image/create') ? 'active' : '' }}"
                                        href="{{ url('admin/breadcrumb-image/create') }}">{{ __('content.breadcrumb_image') }}</a>
                                </li>
                                <li class="nav-item"> <a
                                ...
                                <li class="nav-item"> <a
                                        class="nav-link {{ request()->is('admin/social/create') || request()->is('admin/social/*/edit') ? 'active' : '' }}"
                                        href="{{ url('admin/social/create') }}">{{ __('content.socials') }}</a></li>
                                <li class="nav-item"> <a
                                ...
                                <li class="nav-item"> <a
                                        class="nav-link {{ request()->is('admin/font/create') ? 'active' : '' }}"
                                        href="{{ url('admin/font/create') }}">{{ __('content.font') }}</a></li>
                                <li class="nav-item"> <a
                                        class="nav-link {{ request()->is('admin/draft-view/create') ? 'active' : '' }}"
                                        href="{{ url('admin/draft-view/create') }}">{{ __('content.draft_view') }}</a>
                                </li>
                                <li class="nav-item"> <a
                                        class="nav-link {{ request()->is('admin/tawk-to/create') ? 'active' : '' }}"
                                        href="{{ url('admin/tawk-to/create') }}">{{ __('content.tawk_to') }}</a></li>
                                <li class="nav-item"> <a
                ...
                @hasrole('super-admin')
                    <li
                        class="nav-item {{ request()->is('admin/admin-role') ||
                    ...
                    <li
                        class="nav-item {{ request()->is('admin/admin-user') ||
    ...
    @if (session()->has('site_url'))
        <div class="back-to-site">
            <a href="{{ route('go-to-site-url.index', ['site_url' => session()->get('site_url')]) }}"
                class="btn btn-primary">{{ __('content.see_edit') }} <i class="fas fa-angle-right"></i></a>
        </div>
    @endif
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title mt-0 font-16" id="processedLanguageModalLabel">
                        {{ __('content.which_language') }}</h5>
            ...
            @isset($page_builder)
                ...
                document.querySelectorAll('.move-button').forEach(button => {
                    button.addEventListener('click', (e) => {
                        ...
                        const newDirection = direction === 'left' ? 'right' :
                        'left'; // Reverse direction
                        button.setAttribute('data-direction',
                        newDirection); // Set the new direction of the button
                        ...
                        updateItemData(destinationZone, direction === 'left' ? "left_item" :
                            "updated_item");
