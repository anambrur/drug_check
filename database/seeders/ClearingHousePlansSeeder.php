...
class ClearingHousePlansSeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        $standardFees = [
            ...
            [
                'fee_key' => 'query_admin_fee',
                'fee_label' => 'Query Administration Fee',
        ...
        foreach ($plans as $planData) {
            $plan = ClearingHousePlan::updateOrCreate(
            ...
            foreach ($standardFees as $feeData) {
                ClearingHousePlanFee::updateOrCreate(
                    [
