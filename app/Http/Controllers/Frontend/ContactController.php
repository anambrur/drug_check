...
class ContactController extends Controller
{
    ...
    //                 ->from('drugcheck@skyroshop.com', 'DrugCheckr')  // Authorized sender email
    ...
    {
        return redirect()->back()->with('error', 'This payment flow has been replaced. Please use the checkout button on the test page.');
    }
