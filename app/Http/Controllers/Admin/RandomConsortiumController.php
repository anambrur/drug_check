...
class RandomConsortiumController extends Controller
{
    ...
    public function create($style = 'style1')
    {
        ...
        $item_section = RandomConsortium::where('language_id', $language->id)->where('style', $style)->first();

        return view('admin.random_consortium.create', compact('favicon', 'panel_image', 'item_section', 'style'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        RandomConsortium::find($id)->update($input);
