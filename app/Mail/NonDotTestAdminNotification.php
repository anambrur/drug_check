...
class NonDotTestAdminNotification extends Mailable implements ShouldQueue
{
    ...
    public function envelope(): Envelope
    {
        ...
        return new Envelope(
            subject: 'Non-DOT Application Submission: ' . $applicant . ' - ' . ($this->application->reason_for_testing ?? 'Test Registration'),
            from: new Address(
    ...
    {
        return new Content(
            view: 'emails.non_dot_test_admin_notification',
            with: [
    ...
    {
        Log::error('Queued Non-DOT test admin notification email failed.', [
