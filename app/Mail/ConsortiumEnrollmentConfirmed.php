...
class ConsortiumEnrollmentConfirmed extends Mailable implements ShouldQueue
{
    ...
    {
        return new Envelope(
            subject: 'Random Consortium Enrollment Confirmed - ' . $this->enrollment->company_name,
            from: new Address(
